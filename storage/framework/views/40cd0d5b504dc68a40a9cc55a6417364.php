...
<?php if ($component->shouldRender()): ?>
    ...
    <div class="mt-1 rounded border dark:border-gray-800">
        <div class="flex items-center">
            ...
            >
                <pre class="scrollbar-hidden mx-5 my-3 overflow-y-hidden text-xs lg:text-sm"><code
                        class="overflow-y-hidden scrollbar-hidden overflow-x-scroll scrollbar-hidden-x"><?php echo e($exception->requestBody() ?: 'No body data'); ?></code></pre>
            </span>
        </div>
    </div>
    ...
    <?php if ($routeParametersContext = $exception->applicationRouteParametersContext()): ?>
        ...
        <div class="mt-1 rounded border dark:border-gray-800">
            <div class="flex items-center">
                ...
                >
                    <pre class="scrollbar-hidden mx-5 my-3 overflow-y-hidden text-xs lg:text-sm"><code
                            class="overflow-y-hidden scrollbar-hidden overflow-x-scroll scrollbar-hidden-x"><?php echo e($routeParametersContext); ?></code></pre>
                </span>
            </div>
        </div>
    <?php endif; ?>
...
<?php if (isset($__componentOriginal74daf2d0a9c625ad90327a6043d15980)): ?>
    ...
    <?php unset($__componentOriginal74daf2d0a9c625ad90327a6043d15980); ?>
<?php endif; ?>
<?php /**PATH C:\Users\Gael Navarro\Documents\api-numeriq\vendor\laravel\framework\src\Illuminate\Foundation\Providers/../resources/exceptions/renderer/components/context.blade.php ENDPATH**/ ?>
