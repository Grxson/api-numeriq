...
<?php if ($component->shouldRender()): ?>
    ...
    <div class="md:flex md:items-center md:justify-between md:gap-2">
        ...
        <div class="hidden text-right shrink-0 md:block md:min-w-64 md:max-w-80">
            ...
            <div class="px-4">
                <span
                    class="text-sm text-gray-500 dark:text-gray-400">PHP <?php echo e(PHP_VERSION); ?> — Laravel <?php echo e(app()->version()); ?></span>
            </div>
        </div>
    </div>
...
<?php endif; ?>
<?php /**PATH C:\Users\Gael Navarro\Documents\api-numeriq\vendor\laravel\framework\src\Illuminate\Foundation\Providers/../resources/exceptions/renderer/components/header.blade.php ENDPATH**/ ?>
